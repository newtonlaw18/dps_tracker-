...
class DispatchesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create dispatch" do
    assert_difference('Dispatch.count') do
      post dispatches_url, params: { dispatch: { dps_number: @dispatch.dps_number, status: @dispatch.status } }
    end
  ...
  test "should update dispatch" do
    patch dispatch_url(@dispatch), params: { dispatch: { dps_number: @dispatch.dps_number, status: @dispatch.status } }
